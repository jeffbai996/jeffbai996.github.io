      ...
      <section className="portal-hero">
        ...
        <div className="container">
          <div className="hero-content">
            ...
            <p>Your central gateway to government services in the Republic of Praya. Founded in 2011, our nation has grown from a small settlement to a thriving city-state of 4.2 million residents across our cities and counties — all served through one unified digital platform.</p>
