      ...
      <section className="hero">
        ...
        <div className="container">
          <div className="hero-content">
            ...
            <p>The Legislative Council is the elected representative body of the Republic of Praya, responsible for making laws, approving budgets, and overseeing government operations.</p>
