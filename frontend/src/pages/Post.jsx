      ...
      <section className="hero">
        ...
        <div className="container">
          <div className="hero-content">
            ...
            <p>Praya Post provides fast, reliable mail and package delivery services to every corner of the Republic. Track shipments, buy stamps, and access postal services online.</p>
