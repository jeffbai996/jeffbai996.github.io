...
const searchableContent = [
  ...
  { type: 'department', title: 'Customs & Border Control', description: 'Customs duties, border services, traveler info', url: '/cbca', keywords: ['customs', 'border', 'travel', 'duties', 'declarations', 'traveler'] },
  { type: 'department', title: 'Immigration Department', description: 'Visas, residency, citizenship, PPIC, passports, work and student permits', url: '/immd', keywords: ['immd', 'immigration', 'visa', 'citizenship', 'passport', 'ppic', 'residency', 'permit', 'naturalization'] },
  ...
  { type: 'service', title: 'Apply for Passport', description: 'Submit passport application via IMMD', url: '/immd', keywords: ['passport', 'travel', 'apply', 'pp-1', 'pp-r', 'immigration'] },
  { type: 'service', title: 'Apply for a Visa', description: 'V, F, E, S, or Express visa applications via IMMD', url: '/immd', keywords: ['visa', 'application', 'apply', 'v2', 'f1', 'e-class', 'student', 'express', 'immd'] },
  { type: 'service', title: 'Check Application Status', description: 'Look up IMMD application status by reference number', url: '/immd', keywords: ['status', 'application', 'check', 'reference', 'lookup', 'immd'] },
  { type: 'service', title: 'Citizenship Application', description: 'PIC to PPIC pathway via Form C-11 and I-7 at IMMD', url: '/immd', keywords: ['citizenship', 'naturalization', 'ppic', 'pic', 'c-11', 'i-7', 'oath'] },
  { type: 'service', title: 'Replace Lost PPIC', description: 'File a Form C-3 at IMMD for a lost or stolen PPIC', url: '/immd', keywords: ['ppic', 'lost', 'stolen', 'replace', 'c-3', 'id card', 'identity'] },
